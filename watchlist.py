...
notable_batters = ["Javier Baez", "Eloy Jimenez", "Matt Szczur", "Christian Villanueva",
                   "Arismendy Alcantara", "Tommy La Stella", "Albert Almora", "Albert Almora Jr.", "Willson Contreras", "Billy McKinney",
				   ...
				   "Yonathan Perlaza", "Jonathan Sierra", "Aramis Ademan", "Miguel Amaya", "Kwang-Min Kwon", "D.J. Wilson", "Fidel Mejia", 
				   "Jorge Soler", "Andruw Monasterio", "Ian Rice", "Dexter Fowler", "Chris Coghlan", "Isaac Paredes", "Victor Caratini"]
...
notable_pitchers = ["Carl Edwards Jr.", "Ryan Williams", "Paul Blackburn", "Jen-Ho Tseng",
                    ...
                    "Carlos Pimentel", "Oscar De La Cruz", "Gerardo Concepcion", "Brailyn Marquez", "Brian Matusz", "Faustino Carrera", 
                    "Adam Warren", "Jose Albertos", "Rob Zastryzny", "Clayton Richard", "Mike Montgomery", "Jordan Pries", "Justin Grimm", 
                    "Trevor Clifton", "Manuel Rondon"]
