...
notable_batters = ["Javier Baez", "Eloy Jimenez", "Matt Szczur", "Victor Caratini", "Christian Villanueva",
                   ...
                   "Shawon Dunston Jr.", "Emilio Bonifacio", "Quintin Berry"]
...
notable_pitchers = ["Carl Edwards Jr.", "Ryan Williams", "Paul Blackburn", "Jen-Ho Tseng",
                    ...
                    "Paul Blackburn", "Ryan Williams", "Tsuyoshi Wada", "Duane Underwood Jr.", "Dylan Cease",
                    "Bryan Hudson", "Justin Steele", "Corey Black", "Trevor Cahill", "Tommy Thorpe", "Neil Ramirez",
                    "Carlos Pimentel", "Oscar De La Cruz"]
